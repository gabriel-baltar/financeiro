<div class="container">
	<div class="card">
		...
		<form method="post" class="col-8 offset-2" action="<?=base_url("diretor/procuraBoletosAVencer");?>">
					<h3 class="text-center mt-5">Buscar por Data</h3>
					<div class="row mb-5 mt-5">
						<div class="col-4">
							<label for="inputInicio">Data Início</label>
							<input type="date" name="inicio" class="form-control col-md-9" placeholder="Data Início">
						</div>
						<div class="col-4">
							<label for="inputFim">Data Fim</label>
							<input type="date" name="fim" class="form-control col-md-9" placeholder="Data Fim">
						</div>
						<div class="col-4">
							<label>&nbsp</label>
