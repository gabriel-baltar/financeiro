	...
	<div class="wrapper bg-light">
		...
		<nav id="sidebar" class="">
			...
			<ul class="list-unstyled">
				<p>Opções</p>
				<li>
					<a class="" href="<?=base_url('calendar_diretor/index');?>">Calendário</a>
				</li>
				<li>
					<a class="" href="<?=base_url('diretor/convenio');?>">Lista de Convênios</a>
				</li>
				<li>
					<a href="<?=base_url('diretor/boletospagos');?>" class="">Boletos Pagos</a>
				</li>
				<li>
					<a href="<?=base_url('diretor/boletos_a_vencer');?>" class="">Boletos a Vencer</a>
				</li>
				<li>
